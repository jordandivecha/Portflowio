...
class ModalPost extends React.Component {
 ...
 console.log(this.props.email);
  ...
  render() {
    return (<Modal id="Popout" header='Tell your followers about your project.' trigger={<Button className = "btn-info" > Post</Button>} actions={<Button id = "submitBtn" name = "btn" className = "btn btn-default" onClick = {
        this.handleFormSubmit
      }
      modal = "close" data-confirm = "Are you sure you want to submit?" > Submit</Button>}>
      ...
      <ReactFilestack apikey="AdP2fF1FvRdGW4RWCKw8sz" buttonText="Upload Image" buttonClass="classname" options="" onSuccess={this.makeImage}/>
